...
public class KafkaProducerConfig {
    ...
    public Map<String, Object> producerConfig() {
        ...
        props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, PaymentRequestDTOSerializer.class);
        return props;
    }
    ...
    @Bean
    public KafkaTemplate<String, PaymentRequestDTO> kafkaTemplate(ProducerFactory<String, PaymentRequestDTO> producerFactory) {
