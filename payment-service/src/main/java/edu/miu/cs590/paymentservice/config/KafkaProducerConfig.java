...
public class KafkaProducerConfig {
    ...
    public Map<String, Object> producerConfig() {
        ...
        props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, PaymentRequestSerializer.class);
        return props;
    }
    ...
    @Bean
    public KafkaTemplate<String, PaymentRequest> kafkaTemplate(ProducerFactory<String, PaymentRequest> producerFactory) {
